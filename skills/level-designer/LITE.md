...
|---|---|---|---|
| Project-specific game engine tech stack is active and profile is established | `cat .forgewright/project-profile.json` | ... | run the check command and paste output |
