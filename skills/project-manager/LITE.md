...
| Task boards or target execution files exist in standard directories | `find docs/ -name "*tasks*" -o -name "*roadmap*" -o -name "*milestones*"` | ... | Y/N |
| Standardized product specification templates are onboarded | `cat docs/01-product/TEMPLATE-FEATURE-SPEC.md` | ... | Y/N |
...
3. TRACK | Read and update active status checklists to reflect completed execution steps [2, 6] | Verify checkboxes (`- [ ]`, `- [/]`, `- [x]`) correspond accurately to build and test statuses.
