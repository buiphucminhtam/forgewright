...
|---|---|---|---|
| Target Cargo manifest file exists and specifies dependencies | `cat Cargo.toml` | ... | Y/N |
...
4. SYNC | Write compliant kebab-case reports under docs/ and run post-skill sync hooks | Ensure files are saved using lowercase kebab-case and symlinked to the Shared Obsidian Vault.
