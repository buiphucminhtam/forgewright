...
|---|---|---|---|
| Target Python environment, data packages (pandas, numpy, scikit-learn), and model frameworks are defined | `cat requirements.txt \|\| cat pyproject.toml` | ... | Y/N |
| GitNexus symbol index and dataset profiles are active | `gitnexus analyze --status \|\| find . -name "*.gitnexus"` | ... | Y/N |
