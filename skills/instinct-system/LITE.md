...
|---|---|---|---|
| SQLite Layer 2 Cognitive Graph database (`flux_nodes` and `flux_edges`) is active | `sqlite3 .forgewright/fluxmem.db ".tables"` | ... | Y/N |
| Memory bank structures (persona and scenario layers) are initialized | `find .forgewright/memory-bank/ -name "*.md"` | ... | Y/N |
