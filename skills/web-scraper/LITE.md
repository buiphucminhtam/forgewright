...
| Project-specific tech stack and baseline profile configurations are active | `cat .forgewright/project-profile.json` | ... | run the check command and paste output |
