...
def main():
    ...
    parser.add_argument("--type", default="Task", help="Type of the node (Task, Intent, Decision, Error, etc.)")
    parser.add_argument("--content", required=True, help="Content of the node")
    parser.add_argument("--weight", type=float, default=5.0, help="Initial weight for the node")
    parser.add_argument("--link-to", help="ID of another node to link to")
    parser.add_argument("--relation", default="RELATES_TO", help="Type of relation to the linked node")
