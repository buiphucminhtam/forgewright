...
def test_auto_pruning(memory):
    ...
    memory.add_node("irrelevant_chat", type="Intent", content="Hmm let me see", weight=0.4)
    memory.add_node("important_bug", type="Error", content="Null pointer in DB", weight=8.0)
