...
This project is indexed by GitNexus as **forgewright** (18356 symbols, 24104 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
