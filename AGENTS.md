...
This project is indexed by GitNexus as **forgewright** (21057 symbols, 28884 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
