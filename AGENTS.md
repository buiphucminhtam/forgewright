...
This project is indexed by GitNexus as **forgewright** (20867 symbols, 28418 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
