...
This project is indexed by GitNexus as **forgewright** (19380 symbols, 25138 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
