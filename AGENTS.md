...
# NEW PROJECTS: Use GitNexus instead (see <!-- gitnexus:start -->
# GitNexus — Code Intelligence

This project is indexed by GitNexus as **forgewright** (3871 symbols, 9095 relationships, 265 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
This project is indexed by GitNexus as **forgewright** (18013 symbols, 23694 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
