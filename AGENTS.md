...
This project is indexed by GitNexus as **forgewright** (2979 symbols, 3308 relationships, 45 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
