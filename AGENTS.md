...
This project is indexed by GitNexus as **forgewright** (19409 symbols, 25388 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
