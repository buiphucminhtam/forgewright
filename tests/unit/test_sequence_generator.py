...
def test_sequence_diagram_generation():
    ...
    assert os.path.exists(output_dir), (
        "Output directory docs/architecture/flows/ does not exist"
    )
    ...
    assert os.path.exists(get_flow_path), (
        "GET-_api_projects.md flow diagram was not created"
    )
    ...
    assert os.path.exists(post_flow_path), (
        "POST-_api_projects_setup.md flow diagram was not created"
    )
