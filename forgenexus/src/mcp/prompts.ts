    ...
    prompts: [
      {
        ...
        arguments: [
          { name: "scope", description: 'What to analyze: "unstaged", "staged", "all", or "compare" (default: all)', required: false },
          { name: "base_ref", description: 'Branch/commit for "compare" scope (e.g., "main")', required: false },
        ],
      },
      {
        name: "generate_map",
